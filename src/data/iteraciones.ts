...
export const ITERACIONES: Iteracion[] = [
  ...
  },
  {
    ...
    nombre: "Biblioteca y ruta del café: de la finca a la tostión",
    ...
    historias: [
      ...
      },
      {
        ...
        tags: ["escenas", "sst"],
        requisitos: ["RF-908"],
        dod: [pend("Escena de la tienda (estación 5, la taza) con sus riesgos, textos editables y final correcto.")],
      },
    ],
  },
  {

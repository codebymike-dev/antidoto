...
export const ITERACIONES: Iteracion[] = [
  ...
  },
  {
    ...
    nombre: "Biblioteca, finca y transporte",
    ...
    historias: [
      ...
      {
        id: "AN-32",
        titulo: "Como participante, quiero seguir la ruta del café en la siguiente estación de la cadena para conocer sus riesgos",
        tipo: "historia",
        valor: "alto",
        col: "cola",
        par: "MR",
        tags: ["escenas", "sst"],
        requisitos: ["RF-908"],
        dod: [pend("Definir con el usuario la estación 3 (trilla, tostión o tienda) y sus riesgos.")],
      },
    ],
  },
  {

...
export const ITERACIONES: Iteracion[] = [
  ...
  },
  {
    ...
    nombre: "Biblioteca y ruta del café: finca, transporte y trilladora",
    ...
    historias: [
      ...
      {
        id: "AN-33",
        titulo: "Como participante, quiero seguir la ruta del café en la tostión para conocer sus riesgos",
        tipo: "historia",
        valor: "alto",
        col: "cola",
        par: "MR",
        tags: ["escenas", "sst"],
        requisitos: ["RF-908"],
        dod: [pend("Escena de la tostión (estación 4) con sus riesgos, textos editables y final correcto.")],
      },
    ],
  },
  {
    ...
    historias: [
      ...
      },
      {
        ...
        dod: [
          pend("Acción para cambiar estado y vencimiento de un código existente."),
